 ...
 * {@link ContenedorVendedor.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ContenedorVendedor#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ContenedorVendedor extends Fragment {
     ...
     * @return A new instance of fragment ContenedorVendedor.
     */
    // TODO: Rename and change types and number of parameters
    public static ContenedorVendedor newInstance(String param1, String param2) {
        ContenedorVendedor fragment = new ContenedorVendedor();
    ...
    private void llenarViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FormularioVendedor(), "Datos Vendedor");
        adapter.addFragment(new CatalogoVendedor(), "Catalogo Vendedor");
