...
import com.firecod.avcm_android.components.TableView.popup.ProductoViewModel;
...
public class TableAdapterProducto extends AbstractTableAdapter<ColumnHeaderProducto, RowHeaderProducto, CellProducto>{
    ...
    public AbstractViewHolder onCreateCellViewHolder(ViewGroup parent, int viewType) {
        ...
        View layout;
                ...
                return new ProductoViewModel(layout);
    ...
    public void onBindColumnHeaderViewHolder(AbstractViewHolder holder, Object columnHeaderItemModel, int
            position) {
        Producto columnHeader = (Producto) columnHeaderItemModel;
