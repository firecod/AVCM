...
public class TableAdapterProducto extends AbstractTableAdapter<ColumnHeaderProducto, RowHeaderProducto, CellProducto>{
    ...
    private ViewModelProducto viewModelProducto;

    public TableAdapterProducto(Context context) {
        super(context);
        this.viewModelProducto = new ViewModelProducto();
    }
    ...
    public int getCellItemViewType(int position) {
        return viewModelProducto.getCellItemViewType(position);
    }
    ...
    public void setUserList(List<Producto> productos) {
        ...
        viewModelProducto.generateListForTableView(productos);

        // Now we got what we need to show on TableView.
        setAllItems(viewModelProducto.getColumHeaderModeList(), viewModelProducto
