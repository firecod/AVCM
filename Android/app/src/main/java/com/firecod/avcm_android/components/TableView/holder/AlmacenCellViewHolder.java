...
public class AlmacenCellViewHolder extends AbstractSorterViewHolder {
    public final TextView cell_textview;
    public final LinearLayout cell_container;

    public AlmacenCellViewHolder(View itemView) {
        super(itemView);
        cell_textview = itemView.findViewById(R.id.cell_data_almacen);
        cell_container = itemView.findViewById(R.id.cell_container_almacen);
    }

    public void setCellModel(CellAlmacen p_jModel, int pColumnPosition) {
