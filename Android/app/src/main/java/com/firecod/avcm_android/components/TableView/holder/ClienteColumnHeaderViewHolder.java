...
public class ClienteColumnHeaderViewHolder extends AbstractSorterViewHolder {
    ...
    public void setColumnHeaderModel(ColumnHeaderCliente pColumnHeaderModel, int pColumnPosition) {
