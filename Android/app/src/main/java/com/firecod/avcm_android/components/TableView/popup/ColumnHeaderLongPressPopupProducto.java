        ...
        .OnMenuItemClickListener
{
    ...
    private static final String LOG_TAG = ColumnHeaderLongPressPopupProducto.class.getSimpleName();
    ...
    private ProductoColumnHeaderViewHolder m_iViewHolder;
    private ITableView m_iTableView;
    private Context mContext;
    private int mXPosition;

    public ColumnHeaderLongPressPopupProducto(ProductoColumnHeaderViewHolder p_iViewHolder, ITableView
            p_jTableView) {
        ...
        m_iViewHolder = (ProductoColumnHeaderViewHolder) m_iTableView.getColumnHeaderRecyclerView()
