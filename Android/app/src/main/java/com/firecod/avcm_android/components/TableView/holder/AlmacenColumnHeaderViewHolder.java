...
public class AlmacenColumnHeaderViewHolder extends AbstractSorterViewHolder {
    ...
    public AlmacenColumnHeaderViewHolder(View itemView, ITableView pTableView) {
        super(itemView);
        tableView = pTableView;
        column_header_textview = itemView.findViewById(R.id.column_header_textView_almacen);
        column_header_container = itemView.findViewById(R.id.column_header_container_almacen);
    ...
    public void setColumnHeaderModel(ColumnHeaderAlmacen pColumnHeaderModel, int pColumnPosition) {
