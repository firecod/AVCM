...
public class ControllerVendedor {
    ...
    private Gson gson;
    private String urlGlobal ="http://192.168.43.22:8084/AVCM_WEB/restVendedor/";
    ...
    public void guardarVendedor(final FormularioVendedor act, final Vendedor vendedor)
    {
        ...
        StringRequest sr = new StringRequest(
            ...
            public Map<String, String> getParams() {
                ...
                params.put("almacen", ""+vendedor.getAlmaceno());
                return params;
            }
    ...
    public void cambiarVendedor(final FormularioVendedor act, final Vendedor vendedor)
    {
    ...
    public void eliminarVendedor(final FormularioVendedor act, final Vendedor vendedor)
    {

        Toast t = new Toast(act.requireContext());
        t.makeText(act.requireContext(), "Eliminado...", Toast.LENGTH_LONG).show();
        StringRequest sr = new StringRequest(
                Request.Method.POST, //GET or POST
                urlGlobal + "deleteVendedor", //URL
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
